...
export const SEASONS: Season[] = [
  ...
  { season: "2020-21", wins: 41, losses: 31, pct: .569, coach: "Tom Thibodeau", playoffs: "First Round", playoffResult: "Lost to Hawks 1-4", seed: 4, era: "Thibs Era", leadScorer: "Julius Randle", leadPPG: 24.1, leadRebounder: "Julius Randle", leadRPG: 10.2, leadAssist: "Julius Randle", leadAPG: 6.0, allStars: ["Julius Randle"], keyPlayers: ["Julius Randle","RJ Barrett","Derrick Rose","Immanuel Quickley","Mitchell Robinson","Reggie Bullock"], note: "Thibs COTY! Randle MIP + All-Star. Back to playoffs after 7 years.", offRtg: 110.1, defRtg: 106.7, pace: 97.0 },
...
export const ANOMALIES = [
  ...
  { title: "Brunson's 28.7 PPG Season (2023-24)", desc: "Tied for 3rd-highest single-season PPG in Knicks history with Carmelo Anthony (2012-13), behind Bernard King (32.9) and Richie Guerin (29.5). Context: he made $27M/yr vs KD's $45M.", severity: "historic" as const },
